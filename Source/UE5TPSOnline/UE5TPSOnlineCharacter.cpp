...
void AUE5TPSOnlineCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUE5TPSOnlineCharacter::Move);
...
void AUE5TPSOnlineCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE5TPSOnlineCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
